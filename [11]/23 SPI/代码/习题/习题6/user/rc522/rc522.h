...
#define MFRC522_CS(x) x ? GPIO_SetBits(GPIOD,GPIO_Pin_6):GPIO_ResetBits(GPIOD,GPIO_Pin_6)   //ss 片选信号
...
void rc522_init(void);						//rfidrc522引脚初始化，模拟spi
uint8_t SPI3_Send(u8 val);					//发送数据，并接收数据
...
void MFRC522Test(void);					//RFID模块测试
