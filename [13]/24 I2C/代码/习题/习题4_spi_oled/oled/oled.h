...
#define Y_WIDTH 	64	    						  
//-----------------OLED端口定义----------------  					   
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOC,GPIO_Pin_11)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOC,GPIO_Pin_11)

#define OLED_RST_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_6)//RES
#define OLED_RST_Set() GPIO_SetBits(GPIOC,GPIO_Pin_6)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_8)//DC
#define OLED_DC_Set() GPIO_SetBits(GPIOC,GPIO_Pin_8)

#define OLED_SCLK_Clr() PDout(6) = 0//CLK
#define OLED_SCLK_Set() PDout(6) = 1

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOD,GPIO_Pin_7)//DIN
#define OLED_SDIN_Set() GPIO_SetBits(GPIOD,GPIO_Pin_7)

/*#define OLED_SCLK_Clr() PCout(11)=0//CLK  	PC11
#define OLED_SCLK_Set() PCout(11)=1

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_8)//DIN(D1)	PC8
#define OLED_SDIN_Set() GPIO_SetBits(GPIOC,GPIO_Pin_8)

#define OLED_RST_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_11)//RES		PC6
...
void OLED_ShowNum(u8 x,u8 y,u32 num,u8 len,u8 size,u8 ssize);
