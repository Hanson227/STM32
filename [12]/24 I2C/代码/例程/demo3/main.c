...
int main(void)
{
	...
	//x=0,y=0，显示内容“teacher.wen”,字体大小8x16
	OLED_ShowString(0,0,"teacher.wen",16);
	
	//x=0,y=2，显示内容“teacher.wen”,字体大小8x16
	OLED_ShowString(0,2,"teacher.wen",16);	
	
	//x=90,y=2，显示内容“stm”,字体大小8x16
	OLED_ShowString(90,2,"stm",16);		
	
	//x=20,y=4，显示内容“teacher.wen”,字体大小6x12
	OLED_ShowString(20,4,"teacher.wen",12);		
	
	//x=20,y=6，显示内容“stm32”,字体大小6x12
	OLED_ShowString(20,6,"stm32",12);
